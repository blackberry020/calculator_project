...
/**
 * Precompiled org.blackberry020.java-application-conventions script plugin.
 **/
public class OrgBlackberry020JavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OrgBlackberry020JavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("org.blackberry020.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgBlackberry020JavaApplicationConventions").asSubclass(BasicScript.class);
