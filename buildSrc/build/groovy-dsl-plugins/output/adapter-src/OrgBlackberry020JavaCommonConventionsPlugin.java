...
/**
 * Precompiled org.blackberry020.java-common-conventions script plugin.
 **/
public class OrgBlackberry020JavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OrgBlackberry020JavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgBlackberry020JavaCommonConventions").asSubclass(BasicScript.class);
